...
flowchart_ccodwg_archive <- grViz('digraph flowchart {
      ...
      archivist_test [color = blue, label = <Periodic automated testing<br/>of dataset downloads<br/><i>(archivist -m test)</i>>]
      archivist_prod [color = blue, label = <Nightly archive update<br/><i>(archivist -m prod)</i>>]
      ...
      manual_rerun [color = red, label = <Manually archive failed<br/>datasets, if necessary<br/><i>(archivist -m prod --uuid)</i>>]
